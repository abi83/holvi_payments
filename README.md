# Payments categorisation
A test assignment for python backend engineer role


What as done
1. Invoice class with some service attributes and 'payments_categorisations' method
...
https://6ndg8p4url.execute-api.us-west-2.amazonaws.com/default/holvi-assignmnent
6. CI/CD workflow

What was not done:
1. Input data verification
2. Dnango app. I think it is redundant in this task
3. Cache or database connection
